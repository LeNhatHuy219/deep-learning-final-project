...
└── TASK2
    ...
    ├── BaoCao_XrayCaptioning_Final.docx
    ├── xray_webapp
    │   ├── app.py
    │   ├── model_def.py
    │   ├── requirements.txt
...
Submit these files separately with the GitHub link:
...
- GitHub repository: source code, notebooks, README, and lightweight metadata files.
- Google Drive or HuggingFace Hub: dataset and checkpoints.
- Report: final written report.
- Slides: presentation file.
- Video: 3-5 minute demo video.
